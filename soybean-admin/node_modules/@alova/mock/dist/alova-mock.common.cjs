/**
  * @alova/mock 2.0.18 (https://github.com/alovajs/mock)
...
const defaultMockResponse = ({ status = 200, responseHeaders, statusText = 'ok', body }) => {
    const response = new Response(shared.isSpecialRequestBody(body) ? body : JSON.stringify(body), {
        status,
        statusText,
